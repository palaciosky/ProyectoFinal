...
public class Ventas extends HttpServlet {
     ...
     */
    protected void listaVentas(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/vistas-ventas/listarventas.jsp");
